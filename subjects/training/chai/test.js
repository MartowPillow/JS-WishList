            ...
            request()
                ...
                .then((res) => {
                    ...
                    chai.expect(res.body).to.containSubset(
                        JSON.parse(`[{"date":"01/01/2021","duration":1.5,"type":"bike","uuid":"ad1afbd2-77d2-404e-bbca-3f352f7f09a2"},{"date":"04/01/2021","duration":0.75,"type":"run","uuid":"c067b934-d98f-4d0a-a4a3-c89c05a00e4a"}]`)
                    )
                    done()
                }).catch(done)
        })
        ...
        it('it should be return the element by id', (done) => {
            request()
                ...
                .then((res) => {
                    chai.expect(res).to.have.status(200);
                    chai.expect(res.body).to.containSubset(
                        JSON.parse(`{"date":"01/01/2021","duration":1.5,"type":"bike","uuid":"ad1afbd2-77d2-404e-bbca-3f352f7f09a2"}`)
                    )
                    done()
                }).catch(done)
        })
    ...
    describe('Post', () => {
        ...
        it('it should return 422 when date is null', (done) => {
            request()
                ...
                .set('Authorization', `Bearer ${jwt_user1}`)
                .set('Content-type', 'application/json')
                .send('{"date":null,"duration":42.42,"type":"run"}')
                .then((res) => {
                    chai.expect(res).to.have.status(422);
                    done()
                }).catch(done)
        ...
        it('it should return 422 when date is empty', (done) => {
            request()
                ...
                .set('Authorization', `Bearer ${jwt_user1}`)
                .set('Content-type', 'application/json')
                .send('{"date":"","duration":42.42,"type":"run"}')
                .then((res) => {
                    chai.expect(res).to.have.status(422);
                    done()
                }).catch(done)
        ...
        it('it should return 422 when duration is null', (done) => {
            request()
                ...
                .set('Authorization', `Bearer ${jwt_user1}`)
                .set('Content-type', 'application/json')
                .send('{"duration":null,"date":"Yolo","type":"run"}')
                .then((res) => {
                    chai.expect(res).to.have.status(422);
                    done()
                }).catch(done)
        ...
        it('it should return 422 when duration is a string ', (done) => {
            request()
                ...
                .set('Authorization', `Bearer ${jwt_user1}`)
                .set('Content-type', 'application/json')
                .send('{"duration":"STRING","date":"Yolo","type":"run"}')
                .then((res) => {
                    chai.expect(res).to.have.status(422);
                    done()
                }).catch(done)
        ...
        it('it should return 422 when type is null', (done) => {
            request()
                ...
                .set('Authorization', `Bearer ${jwt_user1}`)
                .set('Content-type', 'application/json')
                .send('{"type":null,"date":"Yolo","duration":42.42}')
                .then((res) => {
                    chai.expect(res).to.have.status(422);
                    done()
                }).catch(done)
        ...
        it('it should return 422 when type is empty', (done) => {
            request()
                ...
                .set('Authorization', `Bearer ${jwt_user1}`)
                .set('Content-type', 'application/json')
                .send('{"type":"","date":"Yolo","duration":42.42}')
                .then((res) => {
                    chai.expect(res).to.have.status(422);
                    done()
                }).catch(done)
        ...
        it('it should return 422 when type is an invalid enum', (done) => {
            request()
                ...
                .set('Authorization', `Bearer ${jwt_user1}`)
                .set('Content-type', 'application/json')
                .send('{"type":"WRONG_ENUM","date":"Yolo","duration":42.42}')
                .then((res) => {
                    chai.expect(res).to.have.status(422);
                    done()
                }).catch(done)
        ...
        it(`it should return 201 when create a valid ${subject}`, (done) => {
            request()
                ...
                .set('Authorization', `Bearer ${jwt_user1}`)
                .set('Content-type', 'application/json')
                .send('{"date":"Yolo","duration":42.42,"type":"run"}')
                .then((res) => {
                    chai.expect(res).to.have.status(201);
                    chai.expect(res.body).to.containSubset(
                        JSON.parse(`{"date":"Yolo","duration":42.42,"type":"run"}`)
                    )
    ...
    describe('Put', () => {
        ...
        it('it should return 422 when duration is null', (done) => {
            request()
                ...
                .set('Authorization', `Bearer ${jwt_user1}`)
                .set('Content-type', 'application/json')
                .send('{"date":"Yolo","duration":null,"type":"run"}')
                .then((res) => {
                    chai.expect(res).to.have.status(422);
                    done()
                }).catch(done)
        ...
        it('it should return 422 when duration is a string ', (done) => {
            request()
                ...
                .set('Authorization', `Bearer ${jwt_user1}`)
                .set('Content-type', 'application/json')
                .send('{"date":"Yolo","duration":"STRING","type":"run"}')
                .then((res) => {
                    chai.expect(res).to.have.status(422);
                    done()
                }).catch(done)
        ...
        it('it should return 422 when type is null', (done) => {
            request()
                ...
                .set('Authorization', `Bearer ${jwt_user1}`)
                .set('Content-type', 'application/json')
                .send('{"date":"Yolo","duration":42.42,"type":null}')
                .then((res) => {
                    chai.expect(res).to.have.status(422);
                    done()
                }).catch(done)
        ...
        it('it should return 422 when type is empty', (done) => {
            request()
                ...
                .set('Authorization', `Bearer ${jwt_user1}`)
                .set('Content-type', 'application/json')
                .send('{"date":"Yolo","duration":42.42,"type":""}')
                .then((res) => {
                    chai.expect(res).to.have.status(422);
                    done()
                }).catch(done)
        ...
        it('it should return 422 when type is an invalid enum', (done) => {
            request()
                ...
                .set('Authorization', `Bearer ${jwt_user1}`)
                .set('Content-type', 'application/json')
                .send('{"date":"Yolo","duration":42.42,"type":"WRONG_ENUM"}')
                .then((res) => {
                    chai.expect(res).to.have.status(422);
                    done()
                }).catch(done)
